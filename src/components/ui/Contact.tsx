      ...
      <div className="text-center text-gray py-5 pt-10">
        <div className="text-xl font-semibold">
          ...
          <span className="flex justify-center gap-2 items-center mt-4 flex-col lg:flex-row">
            ...
            <Link href="mailto:robiulhossain7475@gmail.com" className="mb-2 flex items-center justify-center gap-2 md:text-lg rounded px-6 py-2.5 text-xs font-medium bg-primary leading-normal text-white shadow-md transition duration-150 ease-in-out hover:shadow-lg focus:shadow-lg focus:outline-none focus:ring-0 active:shadow-lg">
              <svg
                xmlns="http://www.w3.org/2000/svg"
                className="h-5 w-5"
                fill="currentColor"
